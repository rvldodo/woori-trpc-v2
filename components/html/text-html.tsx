    ...
    return (
      <p
        className={cn(
          ...
          className,
          "[&_h1]:text-3xl [&_h1]:font-bold [&_h1]:my-6 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:my-4 [&_h3]:text-xl [&_h3]:font-medium [&_h3]:my-4 [&_ul]:list-disc [&_ul]:ml-5 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:ml-5 [&_ol]:space-y-2 [&_li]:my-2 [&_a]:text-blue-600 [&_a]:underline [&_table]:w-full [&_table]:my-4 [&_table]:border-collapse [&_th]:bg-gray-100 [&_th]:p-3 [&_th]:text-left [&_th]:border [&_th]:border-gray-300 [&_td]:p-3 [&_td]:border [&_td]:border-gray-300 [&_tr]:hover:bg-gray-50",
        )}
        ref={ref}
