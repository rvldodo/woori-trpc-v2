...
import customerMeet from "@/public/assets/ilus/our-products/customer-meets.png";
import submitted from "@/public/assets/ilus/submitted.png";
import cmoSurvery from "@/public/assets/ilus/our-products/cmo-survey.png";
import meetWfi from "@/public/assets/ilus/our-products/meet-wfi.png";
import delivery from "@/public/assets/ilus/our-products/delivery.png";
...
export default function ProsesPengajuanTabs() {
  const t = useTranslations("OurProduct.carLoan.prosesPengajuan");
  const proses = [
    {
      image: customerMeet,
