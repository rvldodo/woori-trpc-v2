...
export default function HeroSection() {
  return (
    <article className="relative w-full h-[60vh] bg-[url('/assets/image/our-products/mobil.png')] bg-cover">
